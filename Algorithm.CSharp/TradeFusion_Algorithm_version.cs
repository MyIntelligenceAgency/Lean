...
namespace QuantConnect.Algorithm.CSharp.Alphas
{
    ...
    ///</summary>
    public class TradeFusion_Algorithm_version : QCAlgorithm
    {
...

        {
            ...
            SetSecurityInitializer(security => security.FeeModel = new ConstantFeeModel(100));
